...
public class FifaV3ParserTests
{
    ...
    {
        var rows = _parser.Parse(Fixture.Read("Fifa_V3_Men_FRS_20260611.json"));
    ...
    public void Parses_the_womens_ranking_and_skips_unranked_teams()
    {
        ...
        var rows = _parser.Parse(Fixture.Read("Fifa_V3_Women_FRS_20260419.json"));
    ...
    {
        var codes = _parser.Parse(Fixture.Read("Fifa_V3_Men_FRS_20260611.json")).Select(r => r.ISO3).ToList();
