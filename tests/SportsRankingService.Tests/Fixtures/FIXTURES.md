...
| Wta_Doubles.json | https://api.wtatennis.com/tennis/players/ranked?page=0&pageSize=100&type=rankDoubles&sort=asc&name=&metric=DOUBLES | parses; page 0 of a paged feed (serviceconfig.json puts `{page}` where this URL says `0`): `pageSize` is capped at 100, pages run to about 17 and a page past the end is `[]` (2026-09-22) |
